...
export class ServiceRouteProvider {
        ...
        this.masterServicesList.forEach(service => {
            ...
            switch (service.name) {
                ...
                case 'Call Forwarding Not Reachable' : this.callForwardingNotReachableUrl = this.baseUrl + 'callforwardingnotreachable?';
                                                       this.serviceRouter
                                                         .setCallForwardingNotReachableUrl(this.callForwardingNotReachableUrl);
                                                       break;
                ...
                case 'Sequential Ring' : this.sequentialRingUrl = this.baseUrl + 'sequentialring';
                                         this.serviceRouter.setSequentialRingUrl(this.sequentialRingUrl);
                                         break;
                ...
                case 'Call Center - Basic' : this.callCenterUrl = this.baseUrl + 'callcenter?';
                    this.serviceRouter.setCallCenterUrl(this.callCenterUrl);
                    break;

                case 'Call Center - Standard': this.callCenterUrl = this.baseUrl + 'callcenter?';
                    this.serviceRouter.setCallCenterUrl(this.callCenterUrl);
                    break;

                case 'Call Center - Premium': this.callCenterUrl = this.baseUrl + 'callcenter?';
                    this.serviceRouter.setCallCenterUrl(this.callCenterUrl);

                    break;

                case 'BroadWorks Anywhere' : this.broadWorksAnywhereUrl = this.baseUrl + 'broadworksanywhere';
                                             this.serviceRouter.setBroadWorksAnywhereUrl(this.broadWorksAnywhereUrl);
                                             break;
            }
        });
    ...
    fetchSequentialRingUrl() {
        return this.serviceRouter.getSequentialRingUrl();
    }
    ...
    fetchCallCenterUrl() {
        return this.serviceRouter.getCallCenterUrl();
    }

    fetchPersonalAssistantUrl() {
        return this.serviceRouter.getPersonalAssistantUrl();
    }

    fetchBroadWorksAnywhereUrl() {
        return this.serviceRouter.getBroadWorksAnywhereUrl();
    }
}
