...
export class BlockCallerIdService {
    ...
    putBlockCallerIdService(bcidUrl, isBlockCallerIdChecked, postBCIDPut) {
        let body = '<?xml version="1.0" encoding="UTF-8"?>'
          + '<CallingLineIDDeliveryBlocking xmlns="http://schema.broadsoft.com/xsi"><active>'
          + isBlockCallerIdChecked + '</active></CallingLineIDDeliveryBlocking>';
