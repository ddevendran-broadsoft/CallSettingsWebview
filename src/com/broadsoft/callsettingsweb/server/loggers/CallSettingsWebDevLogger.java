...
public class CallSettingsWebDevLogger implements ApplicationChannelLogger {
	...
	private CallSettingsWebDevLogger() {

	}

	public CallSettingsWebDevLogger(XSPBaseAppContext applicationContext) {
	...
	@Override
	public void logHttpChannel(ChannelSeverity severity, Throwable throwable) {
		convertAndLog(severity, null, throwable);
